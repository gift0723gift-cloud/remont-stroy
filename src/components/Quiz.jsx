          ...
          {isSubmitted && !isCalculating && (
            <div className="text-center py-8 space-y-4 animate-fade-in">
              ...
              <p className="text-gray-400 max-w-md mx-auto text-sm">
                Инженерная калькуляция для площади <span className="text-white font-bold">{area} м²</span> успешно сформирована. Смета и чек-лист уже отправляются в созданную группу Telegram. Наш специалист свяжется с вами в течение 15 минут.
              </p>
            </div>
          )}
