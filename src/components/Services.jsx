...
export default function Services() {
  const servicesList = [
    ...
    },
    {
      ...
      description: 'Укладка плитки и керамогранита крупного формата, запилы под 45°, идеальные швы, работа с диагональю и сложными зонами.',
      whyImportant: 'Неправильная укладка плитки — самая частая причина, почему она отваливается или трескается через 6–12 месяцев. Мы работаем с лазерным уровнем, правильными клеевыми составами и контролируем каждую плитку.',
      icon: '📐'
    },
    {
      id: 4,
